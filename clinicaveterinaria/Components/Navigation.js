...
<MascotaStack.Navigator initialRouteName="Mascota"> 
        ...
        <MascotaStack.Screen name="MascotaInfo" component={MascotaInfo}
        options={{headerBackTitleVisible: false,
        headerTitleAlign:'center',
        headerStyle:{backgroundColor:"#FFD959"}}} />
  ...
  return (
      ...
      <CitasStack.Navigator initialRouteName="Citas"> 
        <CitasStack.Screen
          ...
          headerStyle:{backgroundColor:"#29EAAA"}}}
        />
        <CitasStack.Screen name="CitaCrear" component={CitaCrear}
        options={{headerBackTitleVisible: false,
        headerTitleAlign:'center',
        headerStyle:{backgroundColor:"#FFD959"}}} />
 ...
 function FunctionInicioStack() {
   return(
     ...
     options={{headerBackTitleVisible: false,
      ...
      <InicioStack.Screen name="CitaCrear" component={CitaCrear}
        options={{headerBackTitleVisible: false,
        headerTitleAlign:'center',
        headerStyle:{backgroundColor:"#FFD959"}}} />
     ...
     options={{headerBackTitleVisible: false,
      ...
      <InicioStack.Screen name="MascotaInfo" component={MascotaInfo}
        options={{headerBackTitleVisible: false,
        headerTitleAlign:'center',
        headerStyle:{backgroundColor:"#FFD959"}}} />
    ...
    return(
      ...
      >
       ...
       <Calendario name="calendar-plus" color={color} size={size}></Calendario>
        ...
        <Tab.Screen name="CarritoPrincipal" component={CarritoPrincipal} options={{
         tabBarLabel:'Carrito',
         tabBarIcon:({color,size}) => (
